...
- `noleax-0.5.0-windows-x64.zip`
- `noleax-0.5.0-windows-x64.zip.sha256`
...
`noleax-0.5.0-windows-x64.zip` 与 `.sha256` 作为 workflow artifact 保留（30 天）。当整个 CI
