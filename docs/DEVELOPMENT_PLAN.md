...
> 确认日期：2026-07-29
> 当前阶段：P3 离线分析器
> 已完成工作项：P2.1、P2.2、P2.3、P2.4、P2.5、P2.6、P2.7、P3.1、P3.2、P3.3、P3.4、P3.5、P3.6
> 下一工作项：P3.7 CSV 输出
...
状态：P3.1-P3.6 已通过。events 过滤以及 console/JSON 输出保持流式处理；outstanding 过滤在完整状态
...
调用栈展示和 summary；events writer 不构造全量 DOM，并严格校验 UTF-8。
