...
> 已完成工作项：P2.1、P2.2、P2.3、P2.4、P2.5、P2.6、P2.7、P3.1、P3.2、P3.3、P3.4、P3.5、P3.6、P3.7、P3.8、P4.1、P4.2、P4.3、P4.4、P4.5、P4.6、P4.7、P4.8、P4.9、P5.1、P5.2、P5.3、P5.4、P5.5、P5.6、P5.7、P6.1、P6.2、P6.3、P6.4、P6.5、P6.6、P6.7、P7A、P7B、P7C、P8.1、P8.2、P8.3、P8.4
> 下一工作项：P8.5 用户文档和示例
...
P8.2 于 2026-07-30 完成。干净提交 `74dbf03` 上的基准完成 15 个计入统计的 capture，trace
全部完整且零丢失；默认配置目标区间中位开销为 1.634x。none 的 trace 约为默认 LZ4 的四倍，
单机短跑不足以据此切换 Zstd；V1 保持 LZ4 和 64 帧默认值，最终开销仍由人工验收。

P8.3 于 2026-07-30 完成。CLI recovery suite 覆盖截断尾部、未知 record、未来 minor 扩展、
CRC 损坏和未来 major：可恢复输入返回 2、保留最后一个完整 event chunk 并准确标记完整性；损坏或
不兼容输入返回 4，且不输出伪造的完成状态。Release 定向门禁 1/1 通过。

P8.4 于 2026-07-30 完成。bootstrap ABI v2 增加 controller PID，named pipe 由 controller/agent
双向验证 PID 并继续校验 128-bit token；相关 IPC/controller 定向门禁 9/9 通过。干净提交
`4397e5b` 的正式不可信 trace corpus 共 206/206 完成，0 crash、0 hang、0 非预期退出，最大单例
