...
constexpr std::array<std::byte, 608U> kEntryStub{
    std::byte{0x49}, std::byte{0xBC}, std::byte{0x88}, std::byte{0x77}, std::byte{0x66}, std::byte{0x55}, std::byte{0x44}, std::byte{0x33}, std::byte{0x22}, std::byte{0x11}, std::byte{0x9C}, std::byte{0x50},
    std::byte{0x53}, std::byte{0x51}, std::byte{0x52}, std::byte{0x56}, std::byte{0x57}, std::byte{0x55}, std::byte{0x41}, std::byte{0x50}, std::byte{0x41}, std::byte{0x51}, std::byte{0x41}, std::byte{0x52},
    std::byte{0x41}, std::byte{0x53}, std::byte{0x41}, std::byte{0x54}, std::byte{0x41}, std::byte{0x55}, std::byte{0x41}, std::byte{0x56}, std::byte{0x41}, std::byte{0x57}, std::byte{0x4C}, std::byte{0x8B},
    std::byte{0xF4}, std::byte{0xF3}, std::byte{0x41}, std::byte{0x0F}, std::byte{0x7F}, std::byte{0x44}, std::byte{0x24}, std::byte{0x70}, std::byte{0xF3}, std::byte{0x41}, std::byte{0x0F}, std::byte{0x7F},
    std::byte{0x8C}, std::byte{0x24}, std::byte{0x80}, std::byte{0x00}, std::byte{0x00}, std::byte{0x00}, std::byte{0xF3}, std::byte{0x41}, std::byte{0x0F}, std::byte{0x7F}, std::byte{0x94}, std::byte{0x24},
    std::byte{0x90}, std::byte{0x00}, std::byte{0x00}, std::byte{0x00}, std::byte{0xF3}, std::byte{0x41}, std::byte{0x0F}, std::byte{0x7F}, std::byte{0x9C}, std::byte{0x24}, std::byte{0xA0}, std::byte{0x00},
    std::byte{0x00}, std::byte{0x00}, std::byte{0xF3}, std::byte{0x41}, std::byte{0x0F}, std::byte{0x7F}, std::byte{0xA4}, std::byte{0x24}, std::byte{0xB0}, std::byte{0x00}, std::byte{0x00}, std::byte{0x00},
    std::byte{0xF3}, std::byte{0x41}, std::byte{0x0F}, std::byte{0x7F}, std::byte{0xAC}, std::byte{0x24}, std::byte{0xC0}, std::byte{0x00}, std::byte{0x00}, std::byte{0x00}, std::byte{0xF3}, std::byte{0x41},
    std::byte{0x0F}, std::byte{0x7F}, std::byte{0xB4}, std::byte{0x24}, std::byte{0xD0}, std::byte{0x00}, std::byte{0x00}, std::byte{0x00}, std::byte{0xF3}, std::byte{0x41}, std::byte{0x0F}, std::byte{0x7F},
    std::byte{0xBC}, std::byte{0x24}, std::byte{0xE0}, std::byte{0x00}, std::byte{0x00}, std::byte{0x00}, std::byte{0xF3}, std::byte{0x45}, std::byte{0x0F}, std::byte{0x7F}, std::byte{0x84}, std::byte{0x24},
    std::byte{0xF0}, std::byte{0x00}, std::byte{0x00}, std::byte{0x00}, std::byte{0xF3}, std::byte{0x45}, std::byte{0x0F}, std::byte{0x7F}, std::byte{0x8C}, std::byte{0x24}, std::byte{0x00}, std::byte{0x01},
    std::byte{0x00}, std::byte{0x00}, std::byte{0xF3}, std::byte{0x45}, std::byte{0x0F}, std::byte{0x7F}, std::byte{0x94}, std::byte{0x24}, std::byte{0x10}, std::byte{0x01}, std::byte{0x00}, std::byte{0x00},
    std::byte{0xF3}, std::byte{0x45}, std::byte{0x0F}, std::byte{0x7F}, std::byte{0x9C}, std::byte{0x24}, std::byte{0x20}, std::byte{0x01}, std::byte{0x00}, std::byte{0x00}, std::byte{0xF3}, std::byte{0x45},
    std::byte{0x0F}, std::byte{0x7F}, std::byte{0xA4}, std::byte{0x24}, std::byte{0x30}, std::byte{0x01}, std::byte{0x00}, std::byte{0x00}, std::byte{0xF3}, std::byte{0x45}, std::byte{0x0F}, std::byte{0x7F},
    std::byte{0xAC}, std::byte{0x24}, std::byte{0x40}, std::byte{0x01}, std::byte{0x00}, std::byte{0x00}, std::byte{0xF3}, std::byte{0x45}, std::byte{0x0F}, std::byte{0x7F}, std::byte{0xB4}, std::byte{0x24},
    std::byte{0x50}, std::byte{0x01}, std::byte{0x00}, std::byte{0x00}, std::byte{0xF3}, std::byte{0x45}, std::byte{0x0F}, std::byte{0x7F}, std::byte{0xBC}, std::byte{0x24}, std::byte{0x60}, std::byte{0x01},
    std::byte{0x00}, std::byte{0x00}, std::byte{0x41}, std::byte{0x0F}, std::byte{0xAE}, std::byte{0x9C}, std::byte{0x24}, std::byte{0x70}, std::byte{0x01}, std::byte{0x00}, std::byte{0x00}, std::byte{0x48},
    std::byte{0x83}, std::byte{0xE4}, std::byte{0xF0}, std::byte{0x48}, std::byte{0x83}, std::byte{0xEC}, std::byte{0x60}, std::byte{0x33}, std::byte{0xC9}, std::byte{0x33}, std::byte{0xD2}, std::byte{0x4D},
    std::byte{0x8D}, std::byte{0x44}, std::byte{0x24}, std::byte{0x10}, std::byte{0x4D}, std::byte{0x8D}, std::byte{0x4C}, std::byte{0x24}, std::byte{0x20}, std::byte{0x41}, std::byte{0xFF}, std::byte{0x54},
    std::byte{0x24}, std::byte{0x08}, std::byte{0x41}, std::byte{0x89}, std::byte{0x44}, std::byte{0x24}, std::byte{0x64}, std::byte{0x41}, std::byte{0xC7}, std::byte{0x44}, std::byte{0x24}, std::byte{0x60},
    std::byte{0x01}, std::byte{0x00}, std::byte{0x00}, std::byte{0x00}, std::byte{0x85}, std::byte{0xC0}, std::byte{0x78}, std::byte{0x67}, std::byte{0x49}, std::byte{0x8B}, std::byte{0x44}, std::byte{0x24},
    std::byte{0x20}, std::byte{0x48}, std::byte{0x85}, std::byte{0xC0}, std::byte{0x74}, std::byte{0x5D}, std::byte{0x49}, std::byte{0x8D}, std::byte{0x8C}, std::byte{0x24}, std::byte{0x78}, std::byte{0x01},
    std::byte{0x00}, std::byte{0x00}, std::byte{0x49}, std::byte{0x8B}, std::byte{0x54}, std::byte{0x24}, std::byte{0x28}, std::byte{0x48}, std::byte{0x03}, std::byte{0xD0}, std::byte{0xFF}, std::byte{0xD2},
    std::byte{0x41}, std::byte{0x89}, std::byte{0x44}, std::byte{0x24}, std::byte{0x68}, std::byte{0x41}, std::byte{0xC7}, std::byte{0x44}, std::byte{0x24}, std::byte{0x60}, std::byte{0x02}, std::byte{0x00},
    std::byte{0x00}, std::byte{0x00}, std::byte{0x85}, std::byte{0xC0}, std::byte{0x75}, std::byte{0x39}, std::byte{0x41}, std::byte{0xF6}, std::byte{0x44}, std::byte{0x24}, std::byte{0x58}, std::byte{0x01},
    std::byte{0x74}, std::byte{0x28}, std::byte{0x41}, std::byte{0xBD}, std::byte{0x00}, std::byte{0x00}, std::byte{0x00}, std::byte{0x08}, std::byte{0x49}, std::byte{0x8B}, std::byte{0x5C}, std::byte{0x24},
    std::byte{0x20}, std::byte{0x49}, std::byte{0x03}, std::byte{0x5C}, std::byte{0x24}, std::byte{0x30}, std::byte{0xFF}, std::byte{0xD3}, std::byte{0x84}, std::byte{0xC0}, std::byte{0x75}, std::byte{0x12},
    std::byte{0xF3}, std::byte{0x90}, std::byte{0x41}, std::byte{0xFF}, std::byte{0xCD}, std::byte{0x75}, std::byte{0xF3}, std::byte{0x41}, std::byte{0xC7}, std::byte{0x44}, std::byte{0x24}, std::byte{0x60},
    std::byte{0x04}, std::byte{0x00}, std::byte{0x00}, std::byte{0x00}, std::byte{0xEB}, std::byte{0x09}, std::byte{0x41}, std::byte{0xC7}, std::byte{0x44}, std::byte{0x24}, std::byte{0x60}, std::byte{0x03},
    std::byte{0x00}, std::byte{0x00}, std::byte{0x00}, std::byte{0xFC}, std::byte{0x49}, std::byte{0x8B}, std::byte{0x7C}, std::byte{0x24}, std::byte{0x48}, std::byte{0x49}, std::byte{0x8D}, std::byte{0xB4},
    std::byte{0x24}, std::byte{0x98}, std::byte{0x02}, std::byte{0x00}, std::byte{0x00}, std::byte{0x49}, std::byte{0x8B}, std::byte{0x4C}, std::byte{0x24}, std::byte{0x50}, std::byte{0xF3}, std::byte{0xA4},
    std::byte{0x48}, std::byte{0xC7}, std::byte{0xC1}, std::byte{0xFF}, std::byte{0xFF}, std::byte{0xFF}, std::byte{0xFF}, std::byte{0x49}, std::byte{0x8B}, std::byte{0x54}, std::byte{0x24}, std::byte{0x48},
    std::byte{0x4D}, std::byte{0x8B}, std::byte{0x44}, std::byte{0x24}, std::byte{0x50}, std::byte{0x41}, std::byte{0xFF}, std::byte{0x54}, std::byte{0x24}, std::byte{0x38}, std::byte{0x41}, std::byte{0xC7},
    std::byte{0x44}, std::byte{0x24}, std::byte{0x6C}, std::byte{0x01}, std::byte{0x00}, std::byte{0x00}, std::byte{0x00}, std::byte{0x41}, std::byte{0x0F}, std::byte{0xAE}, std::byte{0x94}, std::byte{0x24},
    std::byte{0x70}, std::byte{0x01}, std::byte{0x00}, std::byte{0x00}, std::byte{0xF3}, std::byte{0x41}, std::byte{0x0F}, std::byte{0x6F}, std::byte{0x44}, std::byte{0x24}, std::byte{0x70}, std::byte{0xF3},
    std::byte{0x41}, std::byte{0x0F}, std::byte{0x6F}, std::byte{0x8C}, std::byte{0x24}, std::byte{0x80}, std::byte{0x00}, std::byte{0x00}, std::byte{0x00}, std::byte{0xF3}, std::byte{0x41}, std::byte{0x0F},
    std::byte{0x6F}, std::byte{0x94}, std::byte{0x24}, std::byte{0x90}, std::byte{0x00}, std::byte{0x00}, std::byte{0x00}, std::byte{0xF3}, std::byte{0x41}, std::byte{0x0F}, std::byte{0x6F}, std::byte{0x9C},
    std::byte{0x24}, std::byte{0xA0}, std::byte{0x00}, std::byte{0x00}, std::byte{0x00}, std::byte{0xF3}, std::byte{0x41}, std::byte{0x0F}, std::byte{0x6F}, std::byte{0xA4}, std::byte{0x24}, std::byte{0xB0},
    std::byte{0x00}, std::byte{0x00}, std::byte{0x00}, std::byte{0xF3}, std::byte{0x41}, std::byte{0x0F}, std::byte{0x6F}, std::byte{0xAC}, std::byte{0x24}, std::byte{0xC0}, std::byte{0x00}, std::byte{0x00},
    std::byte{0x00}, std::byte{0xF3}, std::byte{0x41}, std::byte{0x0F}, std::byte{0x6F}, std::byte{0xB4}, std::byte{0x24}, std::byte{0xD0}, std::byte{0x00}, std::byte{0x00}, std::byte{0x00}, std::byte{0xF3},
    std::byte{0x41}, std::byte{0x0F}, std::byte{0x6F}, std::byte{0xBC}, std::byte{0x24}, std::byte{0xE0}, std::byte{0x00}, std::byte{0x00}, std::byte{0x00}, std::byte{0xF3}, std::byte{0x45}, std::byte{0x0F},
    std::byte{0x6F}, std::byte{0x84}, std::byte{0x24}, std::byte{0xF0}, std::byte{0x00}, std::byte{0x00}, std::byte{0x00}, std::byte{0xF3}, std::byte{0x45}, std::byte{0x0F}, std::byte{0x6F}, std::byte{0x8C},
    std::byte{0x24}, std::byte{0x00}, std::byte{0x01}, std::byte{0x00}, std::byte{0x00}, std::byte{0xF3}, std::byte{0x45}, std::byte{0x0F}, std::byte{0x6F}, std::byte{0x94}, std::byte{0x24}, std::byte{0x10},
    std::byte{0x01}, std::byte{0x00}, std::byte{0x00}, std::byte{0xF3}, std::byte{0x45}, std::byte{0x0F}, std::byte{0x6F}, std::byte{0x9C}, std::byte{0x24}, std::byte{0x20}, std::byte{0x01}, std::byte{0x00},
    std::byte{0x00}, std::byte{0xF3}, std::byte{0x45}, std::byte{0x0F}, std::byte{0x6F}, std::byte{0xA4}, std::byte{0x24}, std::byte{0x30}, std::byte{0x01}, std::byte{0x00}, std::byte{0x00}, std::byte{0xF3},
    std::byte{0x45}, std::byte{0x0F}, std::byte{0x6F}, std::byte{0xAC}, std::byte{0x24}, std::byte{0x40}, std::byte{0x01}, std::byte{0x00}, std::byte{0x00}, std::byte{0xF3}, std::byte{0x45}, std::byte{0x0F},
    std::byte{0x6F}, std::byte{0xB4}, std::byte{0x24}, std::byte{0x50}, std::byte{0x01}, std::byte{0x00}, std::byte{0x00}, std::byte{0xF3}, std::byte{0x45}, std::byte{0x0F}, std::byte{0x6F}, std::byte{0xBC},
    std::byte{0x24}, std::byte{0x60}, std::byte{0x01}, std::byte{0x00}, std::byte{0x00}, std::byte{0x49}, std::byte{0x8B}, std::byte{0xE6}, std::byte{0x49}, std::byte{0x8B}, std::byte{0x44}, std::byte{0x24},
    std::byte{0x40}, std::byte{0x48}, std::byte{0x87}, std::byte{0x44}, std::byte{0x24}, std::byte{0x70}, std::byte{0x41}, std::byte{0x5F}, std::byte{0x41}, std::byte{0x5E}, std::byte{0x41}, std::byte{0x5D},
    std::byte{0x41}, std::byte{0x5C}, std::byte{0x41}, std::byte{0x5B}, std::byte{0x41}, std::byte{0x5A}, std::byte{0x41}, std::byte{0x59}, std::byte{0x41}, std::byte{0x58}, std::byte{0x5D}, std::byte{0x5F},
    std::byte{0x5E}, std::byte{0x5A}, std::byte{0x59}, std::byte{0x5B}, std::byte{0x58}, std::byte{0x9D}, std::byte{0xFF}, std::byte{0xE0},
};
  ...
  [[nodiscard]] EntryStubData wait_for_restored(std::chrono::milliseconds timeout) const {
    ...
    for (;;) {
      ...
      if (std::chrono::steady_clock::now() >= deadline) {
        throw InjectionError{"the entrypoint stub did not finish before the timeout",
                             WAIT_TIMEOUT};
      }
