...
[[nodiscard]] MemoryAnalysisResult analyze_memory_to_console(
    std::istream& input, std::ostream& output, MemoryWindow window,
    ConsoleOptions console_options = {}, EventStreamOptions stream_options = {});
